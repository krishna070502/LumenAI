  ...
  return (
    <div>
      <div className="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-[72px] lg:flex-col border-r border-light-200 dark:border-dark-200">
        <div className="flex h-full flex-col items-center gap-y-4 bg-light-secondary dark:bg-dark-secondary px-2 py-8 shadow-sm shadow-light-200/10 dark:shadow-black/25">
          <a
          ...
          <div className="flex-1 w-full overflow-y-auto no-scrollbar py-4">
          ...
          <div className="flex flex-col items-center gap-y-5 pt-4 border-t border-light-200/50 dark:border-dark-200/50 w-full">
            <UserAvatar />
            <SettingsButton />
          </div>
        </div>
      ...
      <div className="fixed bottom-0 w-full z-50 flex flex-row items-center justify-around bg-light-secondary dark:bg-dark-secondary px-4 py-4 shadow-sm lg:hidden">
        {navLinks.map((link, i) => (
          <Link
            href={link.href}
            key={i}
