...
RUN mkdir -p /home/gradia-aiengine/data
RUN yarn build
...
COPY --from=builder /home/gradia-aiengine/public ./public
COPY --from=builder /home/gradia-aiengine/.next/static ./public/_next/static
COPY --from=builder /home/gradia-aiengine/.next/standalone ./
COPY --from=builder /home/gradia-aiengine/data ./data
COPY drizzle ./drizzle

RUN mkdir /home/gradia-aiengine/uploads
...
CMD ["/home/gradia-aiengine/entrypoint.sh"]
